...
class service_container_prod extends \Drupal\Core\DependencyInjection\Container
{
    ...
    {
        $this->services['account_switcher'] = $instance = new \Drupal\Core\Session\AccountSwitcher($this->get('current_user'), $this->get('session_manager'));
    ...
    {
        $this->services['authentication.cookie'] = $instance = new \Drupal\Core\Authentication\Provider\Cookie($this->get('session_manager'));
    ...
    {
        $this->services['batch.storage'] = $instance = new \Drupal\Core\Batch\BatchStorage($this->get('database'), $this->get('session_manager'), $this->get('csrf_token'));
    ...
    {
        $this->services['cache_contexts'] = $instance = new \Drupal\Core\Cache\CacheContexts($this, array(0 => 'cache_context.url', 1 => 'cache_context.language', 2 => 'cache_context.theme', 3 => 'cache_context.timezone', 4 => 'cache_context.node_view_grants', 5 => 'cache_context.user', 6 => 'cache_context.user.roles'));
    ...
    {
        $this->services['comment.breadcrumb'] = $instance = new \Drupal\comment\CommentBreadcrumbBuilder();
    ...
    {
        $this->services['comment.post_render_cache'] = $instance = new \Drupal\comment\CommentPostRenderCache($this->get('entity.manager'), $this->get('entity.form_builder'));
    ...
    {
        $this->services['entity.query.config'] = $instance = new \Drupal\Core\Config\Entity\Query\QueryFactory($this->get('config.storage'), $this->get('config.factory'));
    ...
    protected function getHttpKernelService()
    {
        ...
        $this->services['http_kernel'] = $instance = new \Stack\StackedHttpKernel($a, array(0 => $a, 1 => $this->get('http_middleware.page_cache'), 2 => $this->get('http_middleware.kernel_pre_handle'), 3 => $this->get('http_kernel.basic')));
    ...
    {
        $this->services['http_middleware.kernel_pre_handle'] = $instance = new \Drupal\Core\StackMiddleware\KernelPreHandle($this->get('http_kernel.basic'), $this->get('kernel'));
    ...
    {
        $this->services['language.default'] = $instance = new \Drupal\Core\Language\LanguageDefault(array('uuid' => '419ec33c-f48f-43a9-8b00-f9918f374e1e', 'langcode' => 'en', 'status' => true, 'dependencies' => array(), 'id' => 'pt-br', 'label' => 'Portuguese, Brazil', 'direction' => 'ltr', 'weight' => 0, 'locked' => false));
    ...
    {
        $this->services['paramconverter.views_ui'] = $instance = new \Drupal\views_ui\ParamConverter\ViewUIConverter($this->get('entity.manager'), $this->get('user.tempstore'));
    ...
    {
        $this->services['path_subscriber'] = $instance = new \Drupal\Core\EventSubscriber\PathSubscriber($this->get('path.alias_manager'), $this->get('path_processor_manager'));
    ...
    {
        $this->services['router.matcher.final_matcher'] = $instance = new \Drupal\Core\Routing\UrlMatcher();
    ...
    {
        $this->services['router.route_provider'] = $instance = new \Drupal\Core\Routing\RouteProvider($this->get('database'), $this->get('router.builder'), $this->get('state'));
    ...
    {
        $this->services['session_manager'] = $instance = new \Drupal\Core\Session\SessionManager($this->get('request_stack'), $this->get('database'), $this->get('session_manager.metadata_bag'), $this->get('session_configuration'));
    ...
    {
        $this->services['system.breadcrumb.default'] = $instance = new \Drupal\system\PathBasedBreadcrumbBuilder($this->get('router.request_context'), $this->get('access_manager'), $this->get('router'), $this->get('path_processor_manager'), $this->get('config.factory'), $this->get('title_resolver'), $this->get('current_user'));
    ...
    {
        $this->services['user.tempstore'] = $instance = new \Drupal\user\TempStoreFactory($this->get('keyvalue.expirable'), $this->get('lock'), 604800);

        $instance->_serviceId = 'user.tempstore';
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'container.namespaces' => array(
                ...
                'Drupal\\language' => '/var/www/drupal8/core/modules/language/src',
                'Drupal\\link' => '/var/www/drupal8/core/modules/link/src',
                'Drupal\\locale' => '/var/www/drupal8/core/modules/locale/src',
            ...
            'language.default_values' => array(
                'uuid' => '419ec33c-f48f-43a9-8b00-f9918f374e1e',
                'langcode' => 'en',
                'status' => true,
                'dependencies' => array(
